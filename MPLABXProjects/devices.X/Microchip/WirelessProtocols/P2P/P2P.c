...
// Channel and PanID data shared between AP and nodes
int myChannel[4] = {26, 25, 15, 20};
int PanID[40] = {0x1234, 0x2345, 0x3456, 0x4567, 0x5678, 0x6789, 0x7890, 0x8901, 0x9012, 0x0123,
				 0x0987, 0x9876, 0x8765, 0x7654, 0x6543, 0x5432, 0x4321, 0x3210, 0x2109, 0x1098,
				 0x1357, 0x2468, 0x3579, 0x4680, 0x5791, 0x6802, 0x7913, 0x8024, 0x9135, 0x0246, 
				 0xABCD, 0xBCDE, 0xCDEF, 0xDEFA, 0xEFAB, 0xFABC, 0x1A2B, 0x2B3C, 0x3C4D, 0x4D5E};
...
BOOL MiApp_ProtocolInit(BOOL bNetworkFreezer)
{
    ...
    TxData = 0;
        ...
        #if defined(IEEE_802_15_4)
//  	      myPANID.Val = MY_PAN_ID;
			myPANID.Val = PanID[PanID_index - 1];
        #endif
    #endif
    
    initValue.PAddress = myLongAddress;
    initValue.actionFlags.bits.CCAEnable = 0;
